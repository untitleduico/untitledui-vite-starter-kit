import { ReplitIcon } from "untitledui-vite-starter-kit";

export const Default = () => <ReplitIcon className="size-10" />;

export const Sizes = () => (
    <div className="flex flex-wrap items-end gap-6">
        <ReplitIcon className="size-5" />
        <ReplitIcon className="size-8" />
        <ReplitIcon className="size-10" />
        <ReplitIcon className="size-14" />
    </div>
);
...
export const Grayscale = () => (
    <div className="flex flex-wrap items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2">
            <ReplitIcon grayscale className="size-10" />
...
export const IntegrationCard = () => (
    <div className="flex items-center gap-3 rounded-xl border border-secondary bg-primary p-4" style={{ width: 320 }}>
        <div className="flex size-10 shrink-0 items-center justify-center rounded-lg border border-secondary">
            <ReplitIcon className="size-6" />
        </div>
        <div className="flex flex-col">
            <span className="text-sm font-semibold text-primary">Replit</span>
