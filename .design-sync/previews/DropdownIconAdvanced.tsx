...
import { DropdownIconAdvanced } from "untitledui-vite-starter-kit";

/** The closed dots trigger. */
export const Trigger = () => <DropdownIconAdvanced />;

/** The advanced menu opened from a dots button. */
