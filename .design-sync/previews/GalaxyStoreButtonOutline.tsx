import { GalaxyStoreButtonOutline } from "untitledui-vite-starter-kit";

/** The outlined Galaxy Store badge. It is drawn in `currentColor`, so it inherits the surrounding text colour. */
export const Default = () => (
    <div className="flex">
        <GalaxyStoreButtonOutline href="#" />
    </div>
);
...
export const InADownloadRow = () => (
    <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap items-center gap-3">
            <GalaxyStoreButtonOutline href="https://galaxystore.samsung.com" /></div>
    </div>
);
