import { CursorIcon } from "untitledui-vite-starter-kit";

export const Default = () => <CursorIcon className="size-10" />;

export const Sizes = () => (
    <div className="flex flex-wrap items-end gap-6">
        <CursorIcon className="size-5" />
        <CursorIcon className="size-8" />
        <CursorIcon className="size-10" />
        <CursorIcon className="size-14" />
    </div>
);
...
export const Grayscale = () => (
    <div className="flex flex-wrap items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2">
            <CursorIcon grayscale className="size-10" />
