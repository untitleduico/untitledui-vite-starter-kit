import { ClaudeIcon } from "untitledui-vite-starter-kit";

export const Default = () => <ClaudeIcon className="size-10" />;

export const Sizes = () => (
    <div className="flex flex-wrap items-end gap-6">
        <ClaudeIcon className="size-5" />
        <ClaudeIcon className="size-8" />
        <ClaudeIcon className="size-10" />
        <ClaudeIcon className="size-14" />
    </div>
);
...
export const Grayscale = () => (
    <div className="flex flex-wrap items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2">
            <ClaudeIcon grayscale className="size-10" />
...
export const IntegrationCard = () => (
    <div className="flex items-center gap-3 rounded-xl border border-secondary bg-primary p-4" style={{ width: 320 }}>
        ...
        <div className="flex flex-col">
            <span className="text-sm font-semibold text-primary">Claude</span>
