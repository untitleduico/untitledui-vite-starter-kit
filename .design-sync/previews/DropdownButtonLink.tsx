...
import { DropdownButtonLink } from "untitledui-vite-starter-kit";

/** The closed trigger renders as an inline text link showing the current permission. */
export const Trigger = () => <DropdownButtonLink />;

/** Permission picker: a single-select section with a checkmark on the current role, plus a destructive Delete action. */
