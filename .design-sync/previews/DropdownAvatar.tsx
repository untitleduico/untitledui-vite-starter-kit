...
import { DropdownAvatar } from "untitledui-vite-starter-kit";

/** The closed trigger is the user's avatar. */
export const Trigger = () => <DropdownAvatar />;

/** Account menu with a profile header, dark-mode toggle, submenu and a Sign out footer. */
