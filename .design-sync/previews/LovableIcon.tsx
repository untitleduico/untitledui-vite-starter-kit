import { LovableIcon } from "untitledui-vite-starter-kit";

export const Default = () => <LovableIcon className="size-10" />;

export const Sizes = () => (
    <div className="flex flex-wrap items-end gap-6">
        <LovableIcon className="size-5" />
        <LovableIcon className="size-8" />
        <LovableIcon className="size-10" />
        <LovableIcon className="size-14" />
    </div>
);
...
export const Grayscale = () => (
    <div className="flex flex-wrap items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2">
            <LovableIcon grayscale className="size-10" />
...
export const IntegrationCard = () => (
    <div className="flex items-center gap-3 rounded-xl border border-secondary bg-primary p-4" style={{ width: 320 }}>
        <div className="flex size-10 shrink-0 items-center justify-center rounded-lg border border-secondary">
            <LovableIcon className="size-6" />
        </div>
        <div className="flex flex-col">
            <span className="text-sm font-semibold text-primary">Lovable</span>
