...
import { DropdownSearchSimple } from "untitledui-vite-starter-kit";

/** The closed "Manage access" trigger. */
export const Trigger = () => <DropdownSearchSimple />;

/** Searchable multi-select list of people with checkbox indicators. */
