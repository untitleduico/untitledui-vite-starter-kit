...
import { DropdownButtonSimple } from "untitledui-vite-starter-kit";

/** The closed trigger: a small secondary button labelled "Account". */
export const Trigger = () => <DropdownButtonSimple />;

/** The menu open - grouped sections with keyboard-shortcut addons and a "View details" submenu. */
