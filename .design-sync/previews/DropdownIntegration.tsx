...
import { DropdownIntegration } from "untitledui-vite-starter-kit";

/** The closed "Copy" trigger button. */
export const Trigger = () => <DropdownIntegration />;

/** Integration menu listing third-party destinations with their brand marks. */
