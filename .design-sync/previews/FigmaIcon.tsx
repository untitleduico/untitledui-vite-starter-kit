import { FigmaIcon } from "untitledui-vite-starter-kit";

export const Default = () => <FigmaIcon className="size-10" />;

export const Sizes = () => (
    <div className="flex flex-wrap items-end gap-6">
        <FigmaIcon className="size-5" />
        <FigmaIcon className="size-8" />
        <FigmaIcon className="size-10" />
        <FigmaIcon className="size-14" />
    </div>
);
...
export const Grayscale = () => (
    <div className="flex flex-wrap items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2">
            <FigmaIcon grayscale className="size-10" />
...
export const IntegrationCard = () => (
    <div className="flex items-center gap-3 rounded-xl border border-secondary bg-primary p-4" style={{ width: 320 }}>
        ...
        <div className="flex flex-col">
            <span className="text-sm font-semibold text-primary">Figma</span>
