import { GrokIcon } from "untitledui-vite-starter-kit";

export const Default = () => <GrokIcon className="size-10" />;

export const Sizes = () => (
    <div className="flex flex-wrap items-end gap-6">
        <GrokIcon className="size-5" />
        <GrokIcon className="size-8" />
        <GrokIcon className="size-10" />
        <GrokIcon className="size-14" />
    </div>
);
...
export const Grayscale = () => (
    <div className="flex flex-wrap items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2">
            <GrokIcon grayscale className="size-10" />
...
export const IntegrationCard = () => (
    <div className="flex items-center gap-3 rounded-xl border border-secondary bg-primary p-4" style={{ width: 320 }}>
        ...
        <div className="flex flex-col">
            <span className="text-sm font-semibold text-primary">Grok</span>
