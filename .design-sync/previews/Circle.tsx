import { Circle } from "untitledui-vite-starter-kit";
...
export const Default = () => (
    <div className="flex w-full items-center justify-center rounded-xl bg-primary" style={{ position: "relative", height: 288, overflow: "hidden" }}>
        ...
        <div className="relative flex flex-col items-center gap-1 text-center">
            <span className="text-lg font-semibold text-primary">No projects yet</span>
            <span className="text-sm text-tertiary">Create your first project to get started.</span>
        </div>
    </div>
);
